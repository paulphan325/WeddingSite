...
<div class="section text-center container">
    ...
    <div class="row registry-wrapper">
        <div class="registry-items row">
            <div class="registry-header-text col-lg-12">What we want most for our wedding is to have all of our friends and family there to celebrate the occasion with us, and so, more than anything we would
