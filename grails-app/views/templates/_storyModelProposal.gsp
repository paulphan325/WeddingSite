<!-- Modal -->
<div id="proposalStory" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">The Proposal</h4>
            </div>

        <div class="modal-body">
            <div class="row">
                <asset:image src="/icons/Proposal.jpg" class="modal-image col-lg-6"/>
                <div class="model-content col-lg-6">
                    <p class="modal-text">The story of the proposal is pretty elaborate.
                    ...
                    mall to get an outfit for the occasion. Caitlin and Ellie then when back home to get all beautifiul and prepared for the big moment!
